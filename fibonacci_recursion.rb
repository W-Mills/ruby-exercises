...
## input : an integer (the desired nth fibonacci num)
## output: an integer (the actual number of the nth fibonacci num)

## clarifying questions: What if n is a negative number? 

## process: use recursion to unpeel to the nth iteration of fibonacci sequence
...
## Example of tail recursion (recursion that is optimized for MUCH faster processing)
