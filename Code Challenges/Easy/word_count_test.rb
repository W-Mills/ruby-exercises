...
class PhraseTest < Minitest::Test
  ...
  def test_counts_with_trailing_apostraphe
    phrase = Phrase.new("Joe can't tell between 'large' and large, or Jess' helpfulness.")
    counts = {
      'joe' => 1, "can't" => 1, 'tell' => 1,
      'between' => 1, 'large' => 2, 'and' => 1, 'or' => 1, "jess'" => 1, "helpfulness" => 1
    }
    assert_equal counts, phrase.word_count
  end
end