...
class MinilangRunttimeError < RuntimeError; end
class BadTokenError < MinilangRunttimeError; end
class EmptyStackError < MinilangRunttimeError; end
...
class Minilang
  ...
  rescue MinilangRunttimeError => error
    puts error.message
  end
